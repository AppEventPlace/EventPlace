...
const ForgPasswordView: React.FC<ForgPassProps> = ({
  navigation,
  Validacion,
  getUserId,
}) => {
  ...
  const handleChange = (name: string, value: any) => {
    ...
    //dispatch(setSecureData({ email: state.email, phone: "" }));
  };
...
export default ForgPasswordView;
